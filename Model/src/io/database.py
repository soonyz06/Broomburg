...
class DatabaseManager:
    ...
    def fetch_database(self, asset_type, filters, limit=None, REFRESH=False, COLLECT=False): 
    ...
    def filter_excludes(self, lf, asset_type, limit, COLLECT=False):
        ...
        exclude_lazy = self._reader.filter_lazy(exclude_lazy, filters={"asset_type": asset_type}, inclusive=True) #filter 
